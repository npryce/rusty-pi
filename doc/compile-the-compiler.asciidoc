...
[abstract]
In which we compile the Rust compiler for the Raspberry Pi, then compile 
Hello World and run it on the Pi.
...
We'll look at ways of doing that in <<dev-environment,the next chapter>>.
