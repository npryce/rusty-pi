...
2K&ohm; resistors to reduce current flow through the Raspberry Pi and ensure we don't burn out it's delicate circuits.

100K&ohm; resistors for to pull input voltages up or down as necessary.
